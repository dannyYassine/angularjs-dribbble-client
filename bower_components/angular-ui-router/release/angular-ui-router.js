 ...
 * in your angular client (use {@link ui.router} module instead).
 *
 */
 ...
 * as a dependency within your angular client. The other modules are for organization purposes.
 *
 * The modules are:
 * * ui.router - the main "umbrella" module
 * * ui.router.router - 
 * 
 * *You'll need to include **only** this module as the dependency within your angular client.*
 * 
 * <pre>
 * <!doctype html>
 * <html ng-client="myApp">
 * <head>
...
function $UrlMatcherFactory() {
   ...
   * @param {Object|Function} definitionFn (optional) A function that is injected before the client
...
function $UrlRouterProvider(   $locationProvider,   $urlMatcherFactory) {
   ...
   * @example
   * <pre>
   * var client = angular.module('client', ['ui.router.router']);
   *
   * client.config(function ($urlRouterProvider) {
 ...
 * nested states.
 *
 * The `$stateProvider` provides interfaces to declare these states for your client.
 */
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
     ...
     * @example
     * <pre>
     * var client angular.module('client', ['ui.router']);
     *
     * client.controller('ctrl', function ($scope, $state) {
     ...
     * @example
     * <pre>
     * //assuming client application consists of 3 states: 'contacts', 'contacts.detail', 'contacts.detail.item'
